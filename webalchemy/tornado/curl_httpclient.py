...
from webalchemy.tornado.httpclient import HTTPResponse, HTTPError, AsyncHTTPClient, main
...
class CurlAsyncHTTPClient(AsyncHTTPClient):
    ...
    def _handle_timeout(self):
        ...
        # (where available) while webalchemy.tornado uses python's time.time()
        # to decide when timeouts have occurred.  When those clocks
        # disagree on elapsed time (as they will whenever there is an
        # NTP adjustment), webalchemy.tornado might call _handle_timeout before
