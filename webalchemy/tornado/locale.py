...
To load a locale and generate a translated string::
    ...
    user_locale = webalchemy.tornado.locale.get("es_LA")
    print user_locale.translate("Sign out")

`webalchemy.tornado.locale.get()` returns the closest matching locale, not necessarily the
...
class CSVLocale(Locale):
    """Locale implementation using webalchemy.tornado's CSV translation format."""
    def translate(self, message, plural_message=None, count=None):
