...
from webalchemy.tornado.util import bytes_type, unicode_type, basestring_type, u
...
# Please see https://github.com/facebook/webalchemy.tornado/pull/706
...
# Use to_unicode instead of webalchemy.tornado.util.u - we don't want backslashes getting
