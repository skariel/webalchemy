...
from webalchemy.tornado.concurrent import TracebackFuture
from webalchemy.tornado.escape import utf8, native_str
from webalchemy.tornado import httpclient, httputil
from webalchemy.tornado.ioloop import IOLoop
from webalchemy.tornado.iostream import StreamClosedError
from webalchemy.tornado.log import gen_log, app_log
from webalchemy.tornado.netutil import Resolver
from webalchemy.tornado import simple_httpclient
...
class WebSocketHandler(webalchemy.tornado.web.RequestHandler):
    ...
    def __init__(self, application, request, **kwargs):
        webalchemy.tornado.web.RequestHandler.__init__(self, application, request,
                                            **kwargs)
    ...
    def write_message(self, message, binary=False):
        ...
        if isinstance(message, dict):
            message = webalchemy.tornado.escape.json_encode(message)
    ...
    def open(self):
        ...
        The arguments to `open` are extracted from the `webalchemy.tornado.web.URLSpec`
        regular expression, just like the arguments to
        `webalchemy.tornado.web.RequestHandler.get`.
        """
        pass
    ...
    def async_callback(self, callback, *args, **kwargs):
        ...
        `webalchemy.tornado.stack_context`.
        """
...
class WebSocketProtocol13(WebSocketProtocol):
    ...
    def write_message(self, message, binary=False):
        ...
        if binary:
            ...
            opcode = 0x1
        message = webalchemy.tornado.escape.utf8(message)
        assert isinstance(message, bytes_type)
        try:
...
if os.environ.get('TORNADO_NO_EXTENSION'):
    ...
    try:
        from webalchemy.tornado.speedups import websocket_mask as _websocket_mask
    except ImportError:
        _websocket_mask = _websocket_mask_python
