"""``webalchemy.tornado.gen`` is a generator-based interface to make it easier to
...
from webalchemy.tornado.stack_context import ExceptionStackContext, wrap
...
def engine(func):
    ...
    `~webalchemy.tornado.web.RequestHandler` :ref:`HTTP verb methods <verbs>`,
...
class Runner(object):
    """Internal implementation of `webalchemy.tornado.gen.engine`.
