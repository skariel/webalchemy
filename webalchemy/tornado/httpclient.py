...
from webalchemy.tornado import httputil, stack_context
...
class AsyncHTTPClient(Configurable):
    ...
    def configure(cls, impl, **kwargs):
        ...
        Example::
           ...
           AsyncHTTPClient.configure("webalchemy.tornado.curl_httpclient.CurlAsyncHTTPClient")
        """
...
class HTTPRequest(object):
    ...
    def __init__(self, url, method="GET", headers=None, body=None,
        ...
        :type headers: `~webalchemy.tornado.httputil.HTTPHeaders` or `dict`
...
class HTTPResponse(object):
    ...
    * headers: `webalchemy.tornado.httputil.HTTPHeaders` object
