...
from webalchemy.tornado.escape import json_decode, utf8, to_unicode, recursive_unicode, native_str, to_basestring
from webalchemy.tornado.httputil import format_timestamp
from webalchemy.tornado.iostream import IOStream
from webalchemy.tornado.log import app_log, gen_log
from webalchemy.tornado.simple_httpclient import SimpleAsyncHTTPClient
from webalchemy.tornado.template import DictLoader
from webalchemy.tornado.testing import AsyncHTTPTestCase, ExpectLog
from webalchemy.tornado.test.util import unittest
from webalchemy.tornado.util import u, bytes_type, ObjectDict, unicode_type
from webalchemy.tornado.web import RequestHandler, authenticated, Application, asynchronous, url, HTTPError, StaticFileHandler, _create_signature, create_signed_value, ErrorHandler, UIModule, MissingArgumentError
...
class HandlerByNameTest(WebTestCase):
    def get_handlers(self):
        ...
        return [('/hello1', HelloHandler),
                ('/hello2', 'webalchemy.tornado.test.web_test.HelloHandler'),
                url('/hello3', 'webalchemy.tornado.test.web_test.HelloHandler'),
                ]
