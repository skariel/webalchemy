...
try:
    ...
    from webalchemy.tornado.platform.twisted import TornadoReactor, TwistedIOLoop
...
from webalchemy.tornado.platform.auto import set_close_exec
from webalchemy.tornado.platform.select import SelectIOLoop
from webalchemy.tornado.testing import bind_unused_port
from webalchemy.tornado.test.util import unittest
from webalchemy.tornado.util import import_object
from webalchemy.tornado.web import RequestHandler, Application
...
# Test various combinations of twisted and webalchemy.tornado http servers,
...
class CompatibilityTests(unittest.TestCase):
    ...
    def testTornadoServerTwistedClientIOLoop(self):
        ...
        self.assertEqual(response, 'Hello from webalchemy.tornado!')
    ...
    for test_name, blacklist in twisted_tests.items():
        ...
        def make_test_subclass(test_class):
            class TornadoTest(test_class):
                _reactors = ["webalchemy.tornado.platform.twisted._TestReactor"]
