...
from webalchemy.tornado.simple_httpclient import SimpleAsyncHTTPClient, _DEFAULT_CA_CERTS
from webalchemy.tornado.test.httpclient_test import ChunkHandler, CountdownHandler, HelloWorldHandler
from webalchemy.tornado.test import httpclient_test
from webalchemy.tornado.testing import AsyncHTTPTestCase, AsyncHTTPSTestCase, AsyncTestCase, bind_unused_port, ExpectLog
from webalchemy.tornado.test.util import unittest, skipOnTravis
from webalchemy.tornado.web import RequestHandler, Application, asynchronous, url
...
class SimpleHTTPClientTestMixin(object):
    ...
    def test_no_content(self):
        ...
        # 204 status doesn't need a content-length, but webalchemy.tornado will
