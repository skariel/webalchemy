...
from webalchemy.tornado.netutil import BlockingResolver, ThreadedResolver, is_valid_ip
from webalchemy.tornado.stack_context import ExceptionStackContext
from webalchemy.tornado.testing import AsyncTestCase, gen_test
...
try:
    ...
    from webalchemy.tornado.platform.caresresolver import CaresResolver
...
try:
    ...
    from webalchemy.tornado.platform.twisted import TwistedResolver
...
class ThreadedResolverImportTest(unittest.TestCase):
    def test_import(self):
        ...
        command = [
            sys.executable,
            '-c',
            'import webalchemy.tornado.test.resolve_test_helper']
