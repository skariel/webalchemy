...
To test:
python3.4 -m webalchemy.tornado.test.runtests --ioloop=webalchemy.tornado.platform.asyncio.AsyncIOLoop
python3.4 -m webalchemy.tornado.test.runtests --ioloop=webalchemy.tornado.platform.asyncio.AsyncIOMainLoop
