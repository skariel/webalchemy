...
option namespace, e.g.::
    ...
    from webalchemy.tornado.options import define, options
...
either::
    ...
    webalchemy.tornado.options.parse_command_line()
    # or
    webalchemy.tornado.options.parse_config_file("/etc/server.conf")
...
`webalchemy.tornado.options.options` is a singleton instance of `OptionParser`, and
...
from webalchemy.tornado.log import define_logging_options
from webalchemy.tornado import stack_context
from webalchemy.tornado.util import basestring_type, exec_in
...
class OptionParser(object):
    ...
    Normally accessed via static functions in the `webalchemy.tornado.options` module,
    ...
    def group_dict(self, group):
        ...
        Useful for copying options into Application settings::
            ...
            from webalchemy.tornado.options import define, parse_command_line, options
